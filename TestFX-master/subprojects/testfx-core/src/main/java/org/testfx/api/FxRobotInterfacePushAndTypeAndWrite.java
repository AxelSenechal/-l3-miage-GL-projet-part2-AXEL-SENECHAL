...
//-----------------------------------------------------------------------------------------------------------
     ...
     */
    FxRobot eraseText(int characters);
